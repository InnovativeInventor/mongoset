...
class Table:
    def __init__(self, client: pymongo.MongoClient, db_name: str = "database", table_name: str = "table"):
        self.client = client
        self.db_name = db_name
    ...
    def find_one(self, projection=None, **filter_expr) -> dict:
        ...
        return self._convert_id_to_str(dict(self.table.find_one(filter_expr, projection)))
